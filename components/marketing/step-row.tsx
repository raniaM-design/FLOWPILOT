      ...
      {steps.map((step, index) => {
        ...
        return (
          <div key={index} className="relative">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 text-center transition-all duration-200 hover:shadow-md hover:-translate-y-[1px]">
              ...
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-50 mx-auto mb-4">
